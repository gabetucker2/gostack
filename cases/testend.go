 ...
 */
 func test_StackProperties(stack *Stack, size []int, depth ...int) (test bool) {
	...
	if stack.Size != len(stack.Cards) || stack.Height != depth
		test = false
	else
