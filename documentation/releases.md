...
* The **Depth** property of **Stacks** is renamed to **Height** to better demonstrate what the property reflects conceptually
* ***gostack***'s default have been adjusted to decrease the likelihood of having to pass repeated `nil` values
