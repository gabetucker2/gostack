...
This library was designed to be as general-purpose as possible so that any coding project with data structures would benefit from ***gostack***.  The idea is that every possible thing you could need to code is broken into some modular function in ***gostack***.
